...
?>
	...
	<a href="view_product.php"><button class="btn">back</button></a>
	</div>
	<?php
	...
	?>			<table>
				...
				<tr>
					<td>Product Name</td>
					<td><input class="inputs" type="text" placeholder="Product Name" name="pname" value="<?php echo $row->ProductName; ?>" /></td>
				</tr>
				<tr>
					<td>Brand Name</td>
					<td><input class="inputs" type="text" placeholder="Brand Name" name="pbrand" value="<?php echo $row->ProductBrand; ?>" /></td>
				</tr>
				<tr>
					<td>Product Price</td>
					<td><input class="inputs" type="text" placeholder="Product Price" name="pprice" value="<?=$row->ProductPrice; ?>" /></td>
				</tr>
				<tr>	
					<td>Product Type</td>
					<td>
				...
				?>
					<td>Product Stock </td><td><input class="inputs" type="text" placeholder="size" name="sizeone" value="<?php echo  $row1->ProductInventorySize; ?>" /></td>
					<input type="hidden" name="size_one" value="<?php echo  $row1->ProductInventorySize; ?>">
					<td><input class="inputs" type="text" placeholder="Product Stock" name="pstockS" value="<?php echo $row1->ProductInventoryStock; ?>" /></td>
					<input type="hidden" name="idone" value="<?php echo  $row1->ProductInventoryID; ?>">
				</tr>
				<tr>
					<td>Product Stock <?php $row1=$rs1->fetch_object(); ?></td><td><input class="inputs" type="text" placeholder="size" name="sizetwo"  value="<?php echo  $row1->ProductInventorySize; ?>"/></td>
					<input type="hidden" name="size_two" value="<?php echo  $row1->ProductInventorySize; ?>">
					<td><input class="inputs" type="text" placeholder="Product Stock" name="pstockM" value="<?php echo $row1->ProductInventoryStock; ?>" /></td>
					<input type="hidden" name="idtwo" value="<?php echo  $row1->ProductInventoryID; ?>">
				</tr>
				<tr>
					<td>Product Stock <?php $row1=$rs1->fetch_object(); ?></td><td><input class="inputs" type="text" placeholder="size" name="sizethree"  value="<?php echo  $row1->ProductInventorySize; ?>"/></td>
					<input type="hidden" name="size_three" value="<?php echo  $row1->ProductInventorySize; ?>">
					<td><input class="inputs" type="text" placeholder="Product Stock" name="pstockL" value="<?php echo $row1->ProductInventoryStock; ?>" /></td>
				...
				<tr>
					<td></td>
					<td>
						<input class="btn" type="submit" value="Update Item to Product" />
					</td>
				</tr>
			</table>
		</form>
